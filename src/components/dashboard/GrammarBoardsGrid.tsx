...
export default function GrammarBoardsGrid() {
  const { data: boards, isLoading } = useBoards('grammar');
  ...
  return (
    <div className="p-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-black mb-2">Grammar Boards</h1>
            ...
            <div key={board.id} className="relative group">
              ...
              >
                ...
                <div className="text-xs text-gray-500">
                  {(board.itemIds as string[]).length} grammar items
                </div>
              </Link>
