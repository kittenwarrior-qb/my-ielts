...
interface DeleteExpressionDialogProps {
  expression: { id: string; expression: string } | null;
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
}

export default function DeleteExpressionDialog({ 
  expression, 
  isOpen, 
  onClose, 
  onConfirm 
        ...
        <div className="flex items-start gap-4 mb-4">
          ...
          <div className="flex-1">
            <h3 className="text-lg font-bold text-gray-900 mb-2">
              Xác nhận xóa expression
            </h3>
            <p className="text-sm text-gray-600 mb-2">
              Bạn có chắc chắn muốn xóa <strong>"{expression.expression}"</strong>?
            </p>
