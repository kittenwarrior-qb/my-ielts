...
export default function CreateLessonModal({ boardId, isOpen, onClose, onSuccess }: CreateLessonModalProps) {
      ...
      <div className="bg-white rounded-lg max-w-md w-full">
        <div className="p-6">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl font-bold">Tạo Lesson Mới</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Mô tả ngắn về lesson này..."
              />
            </div>
